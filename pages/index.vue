...
<template>
  <v-container>
    ...
    <div class="h-24"></div>
    <div align="center">
      <v-img src="https://dvso56c4dpyp.cloudfront.net/urunoki_top.png" class="w-screen" />
    </div>

    <div class="mt-5 main-color text-14" align="center">
      一般社団法人うるの木では<br />
    ...
    <h2 class="mt-8 title text-20b">お知らせ</h2>
    <ul class="mt-4 main-color notice-wrapper">
    ...
    <h2 class="mt-8 title text-20b">理事紹介</h2>
    <h2 class="mt-8 title text-20b">児童発達支援</h2>
    <h2 class="mt-8 title text-20b">WACCA</h2>
    <h2 class="mt-8 title text-20b">イベント情報</h2>
    <h2 class="mt-8 title text-20b">寄付のお願い</h2>
    <h2 class="mt-8 title text-20b">問い合わせ</h2>
  </v-container>
</template>
<style scoped>
.main-color {
